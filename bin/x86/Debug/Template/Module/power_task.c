...
/*
	...
	mipi_dataarray[0] = 0x9f;
	mipi_dataarray[1] = 0x50;
	mipi_write_regs(&srtmipiport,mipi_dataarray,2);	

	
	mipi_dataarray[0] = 0xff;
	mipi_dataarray[1] = 0x23;
	mipi_write_regs(&srtmipiport,mipi_dataarray,2);	
	...
	mipi_dataarray[0] = 0x14;
	mipi_dataarray[1] = 0x60;
	mipi_write_regs(&srtmipiport,mipi_dataarray,2);	

	mipi_dataarray[0] = 0x16;
	mipi_dataarray[1] = 0xc0;
	mipi_write_regs(&srtmipiport,mipi_dataarray,2);	

	mipi_dataarray[0] = 0x4f;
	mipi_dataarray[1] = 0x02;
	mipi_write_regs(&srtmipiport,mipi_dataarray,2);	
	...
	mipi_dataarray[0] = 0x3a;
	mipi_dataarray[1] = 0x08;
	mipi_write_regs(&srtmipiport,mipi_dataarray,2);
	bsp_DelayMS(10);	
	mipi_dataarray[0] = 0xff;
	mipi_dataarray[1] = 0xd0;
	...
	mipi_dataarray[0] = 0xb9;
	mipi_dataarray[1] = 0x05;
	mipi_write_regs(&srtmipiport,mipi_dataarray,2);	
	
	mipi_dataarray[0] = 0xff;
	mipi_dataarray[1] = 0x20;
	mipi_write_regs(&srtmipiport,mipi_dataarray,2);	
	...
	mipi_dataarray[0] = 0x18;
	mipi_dataarray[1] = 0x40;
	mipi_write_regs(&srtmipiport,mipi_dataarray,2);	
	...
	mipi_dataarray[0] = 0x35;
	mipi_dataarray[1] = 0x00;
	mipi_write_regs(&srtmipiport,mipi_dataarray,2);	

	mipi_dataarray[0] = 0xbb;
	mipi_dataarray[1] = 0x13;
	mipi_write_regs(&srtmipiport,mipi_dataarray,2);	
	bsp_DelayMS(10);	
	mipi_dataarray[0] = 0x3b;
	mipi_dataarray[1] = 0x03;
	mipi_dataarray[2] = 0xac;	
	mipi_dataarray[3] = 0x1a;	
	mipi_dataarray[4] = 0x04;	
	mipi_dataarray[5] = 0x04;		
	mipi_write_regs(&srtmipiport,mipi_dataarray,6);	
//	bsp_DelayMS(5);	
