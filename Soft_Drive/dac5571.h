...
DAC5571_RET_CODE_T i2c_read1(unsigned char addr, unsigned char *data, unsigned short len);
DAC5571_RET_CODE_T i2c_write1(unsigned char addr, unsigned char *data, unsigned short len);
void set_otpvcc(uint16_t vol);
void set_tpvcc(uint16_t vol);
