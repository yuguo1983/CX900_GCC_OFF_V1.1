...
//内存池(4字节对齐)
__attribute__ ((aligned (4))) uint8_t mem1base[MEM1_MAX_SIZE] ;
//__attribute__ ((aligned (4))) uint8_t mem2base[MEM2_MAX_SIZE] __attribute__((at(0x68000000))); //外部SRAM内存池
//__attribute__ ((aligned (4))) uint8_t mem3base[MEM3_MAX_SIZE] __attribute__((at(0x10000000))); //内部CMM内存池
//内存管理表
